...
class Plugin_Name_Post_Types {
    ...
    //JAI add custom post type for Scene

    public function create_custom_post_type_scene() {
        ...
        $post_types_fields = array(
            ...
            array(
                 ...
                 */
                'description'           => 'Information describing Scenes content type',
                ...
                'rewrite' => array(
                    ...
                    'slug'       => 'scenes', // string (defaults to the post type name)
