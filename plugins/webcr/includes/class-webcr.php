...
class Webcr {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'init', $plugin_admin_scene, 'add_custom_rewrite_rules' ); // New Claude code
	//	$this->loader->add_filter( 'rewrite_rules_array', $plugin_admin_scene, 'add_scene_rewrite_rules'); // FUNCTION REPLACED WITH OTHER REWRITE RULES
//		$this->loader->add_filter( 'post_type_link', $plugin_admin_scene, 'remove_scene_slug', 10, 3); // FUNCTION REPLACED WITH OTHER REWRITE RULES
