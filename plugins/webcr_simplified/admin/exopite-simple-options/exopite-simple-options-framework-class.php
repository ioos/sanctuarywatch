...
//				$this->config = wp_parse_args( $this->config, $default );
		...
		public function get_menu_item( $section, $force_hidden, $active = '' ) {
//	JAI 	public function get_menu_item( $section, $active = '', $force_hidden ) {
			...
			foreach ( $this->elements as $key => $value ) {
				...
				if( isset( $value['sections'] ) ) {
					...
					foreach ( $value['sections'] as $section ) {
						...
						if( isset( $section['fields'] ) ) {
							$this->get_menu_item( $section, false, $active);
// JAI							$this->get_menu_item( $section, $active, false );
					...
					if( isset( $value['fields'] ) ) {
							$this->get_menu_item( $value, false, $active);
// JAI						$this->get_menu_item( $value, $active, false );
